...
document.addEventListener("mousemove", (e) => {
  // document.getElementById("cube").style.transform = `rotateX(${e.pageX}deg) rotateY(${e.pageY}deg);`
  document.getElementById("cube").style.transform = `rotateX(${e.pageY}deg) rotateY(${e.pageX}deg) translate(calc(50% - 150px), calc(50% - 150px)`;
})